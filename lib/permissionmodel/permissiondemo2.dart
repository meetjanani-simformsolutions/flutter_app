...
class PermissionDemo2 extends StatefulWidget {
  @override
  _PermissionDemo2State createState() => _PermissionDemo2State();
}

class _PermissionDemo2State extends State<PermissionDemo2> {
  @override
